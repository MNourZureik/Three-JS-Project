...
export default class Water_Class {
    constructor() {
        this.main = new Main();
        this.debug = this.main.debug;
        this.scene = this.main.scene;
        this.resources = this.main.resources;
        this.waterGeometry = new THREE.PlaneGeometry(100000* 2, 100000* 2, 512, 512);
        this.surfaceColor = '#186691';
        this.depthColor = '#9bd8ff';
    ...
    set_texture() {
        ...
        this.textures.normalSampler = this.resources.items.water;
    ...
    set_water_mesh() {
        ...
        this.water.material.uniforms.size.value = 0.1;
    ...
    update() {
        ...
        //this.waterMaterial.uniforms.uTime.value = this.main.time.elapsed * 0.001;
    }
}